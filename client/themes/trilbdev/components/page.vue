        ...
        v-layout(row)
          v-flex.page-col-sd(
            ...
            v-card.page-toc-card.mb-5(v-if='tocDecoded.length')
              .overline.pa-5.pb-0(:class='$vuetify.theme.dark ? `purple--text text--lighten-2` : `primary--text`') {{$t('common:page.toc')}}
            ...
            v-card.page-comments-card.mb-5(v-if='commentsEnabled && commentsPerms.read')
              .pa-5
                .overline.pb-2.purple-grey--text.d-flex.align-center(:class='$vuetify.theme.dark ? `text--lighten-3` : `text--darken-2`')
                  ...
                  //-   label
                  //-   x-small
                  //-   :color='$vuetify.theme.dark ? `purple-grey darken-3` : `purple-grey darken-2`'
                  //-   dark
                ...
                .d-flex
                  v-btn.text-none(
                    @click='goToComments()'
                    :color='$vuetify.theme.dark ? `purple-grey` : `purple-grey darken-2`'
                    outlined
                    style='flex: 1 1 100%;'
                    small
                    )
                    span.purple-grey--text(:class='$vuetify.theme.dark ? `text--lighten-1` : `text--darken-2`') {{$t('common:comments.viewDiscussion')}}
                  v-tooltip(right, v-if='commentsPerms.write')
                    template(v-slot:activator='{ on }')
                      v-btn.ml-2(
                        ...
                        v-icon(:color='$vuetify.theme.dark ? `purple-grey lighten-1` : `purple-grey darken-2`', dense) mdi-comment-plus
